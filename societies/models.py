...
class user_societies(models.Model):
    ...
    society_id = models.ForeignKey(society, on_delete=models.CASCADE, null=True, blank=True,
                                   related_name='UserSocieties')
    user_id = models.ForeignKey(Users, related_name='UserSocieties', on_delete=models.CASCADE, null=True, blank=True)
    role_id = models.ForeignKey(UserRoles, related_name='RoleSocieties', on_delete=models.CASCADE, null=True,
                                blank=True)
...
FATHER_HUSBAND_CHOICES = (("son", "son"), ("daughter", "daughter"), ("wife", "wife"))
RESIDENTIAL_COMMERCIAL_CHOICES = (("residential", "residential"), ("commercial", "commercial"))


class members(models.Model):
    society_id = models.ForeignKey(society, on_delete=models.CASCADE, related_name='membersSociety', null=True,
                                   blank=True)
    user_id = models.ForeignKey(Users, on_delete=models.CASCADE, related_name='membersUser', null=True, blank=True)
    ...
    res_com = models.CharField(choices=RESIDENTIAL_COMMERCIAL_CHOICES, max_length=264, null=True, blank=True)
    ...
    fh_type = models.CharField(choices=FATHER_HUSBAND_CHOICES, max_length=264, null=True, blank=True)
    fh_name = models.CharField(max_length=264, null=True, blank=True)
    gender = models.CharField(choices=GENDER_CHOICES, max_length=264, null=True, blank=True)
...
class member_employee_info(models.Model):
    society_id = models.ForeignKey(society, on_delete=models.CASCADE, related_name='memberemployeeSociety',
...
class plot_size(models.Model):
    society_id = models.ForeignKey(society, on_delete=models.CASCADE, related_name='societyPlotSize', null=True,
                                   blank=True)
...
class plots(models.Model):
    ...
    plot_size_id = models.ForeignKey(plot_size, on_delete=models.CASCADE, related_name='societyPlotSize', null=True,
                                     blank=True)
    plot_size_category_id = models.ForeignKey(plot_size_categories, on_delete=models.CASCADE,
                                              related_name='societyPlotSize', null=True, blank=True)
    mysql_id = models.IntegerField(null=True, blank=True)
...
class member_plots(models.Model):
    member_id = models.ForeignKey(members, on_delete=models.CASCADE, related_name='Members', null=True, blank=True)
    plot_id = models.ForeignKey(plots, on_delete=models.CASCADE, related_name='Plots', null=True, blank=True)
    mysql_id = models.IntegerField(null=True, blank=True)
