...
urlpatterns = [
    ...
    path("show_user/<int:id_>", views.show_user),
    path("update_user/<int:id_>", views.update_user),
    path("delete_user/<int:id_>", views.delete_user),
    path("decorator_test/", views.decorator_test),

    path("create_user_role/", views.create_user_role),
    path("show_users_roles/", views.show_users_roles),
    path("show_user_role/<int:id_>", views.show_user_role),
    path("update_user_role/<int:id_>", views.update_user_role),
    path("delete_user_role/<int:id_>", views.delete_user_role),
